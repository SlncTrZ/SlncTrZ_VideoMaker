...
| Night (lamplight) | Warm yellow accents, light-dark contrast | Lamplight flickering, city night view |
...
| Indoor daytime → Indoor night | Spatial structure, furniture | Overall tone warming, add desk lamp/floor lamp elements |
...
```
Modern urban derivative scene image, based on reference,
...
| R10 | Materials must have natural wear/usetraces, prohibit brand-new flawless "CG feel" |
...
| X7 | Material too clean and perfect, no usetraces or age feel (avoid "plastic feel") |
