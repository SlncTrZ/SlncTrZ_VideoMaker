...
5. **Cel Shading Anchored** — All variants must maintain anime style, maintain clear lines and cel shading coloring
...
|---|---|---|
| Early Morning | Cool white light tone, misty feel | Morning light faint, early morning mist |
...
| Night (Lamplight) | Warm yellow accents, light-dark contrast | Lamplight dim, lighting atmosphere |
...
| Indoor Day → Indoor Night | Spatial structure, furniture | Overall tone warms, add indoor lighting |
...
Anime derivative scene image, based on reference image,
...
| R8 | Must include "anime style" keywords (anime style / cel shading) |
| R9 | Must include depth of field features (shallow depth of field / vignette at least one), maintain anime cel shading style |
| R10 | Materials must have modern use marks/lived-in feel, prohibit flawless "3D rendering feel" |
...
| X6 | 3D rendering/CG animation/game engine texture (disable 3D render, CGI, Unreal Engine, Unity, etc.) |
