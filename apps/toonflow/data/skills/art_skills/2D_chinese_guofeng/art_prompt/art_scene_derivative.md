...
5. **Anime Anchored** — All variants must maintain Chinese-style anime texture, reject 3D realistic/CG animation feel; retain delicate lines, cel shading flat coloring, Japanese rendering
...
|---|---|---|---|
| Extreme Wide Shot | Scene overview + surrounding environment | Establish spatial awareness, location | extreme wide shot, extreme wide shot |
| Wide Shot | Complete scene presentation | Show spatial structure | wide shot, wide shot |
| Medium Shot | Scene partial area | Focus on functional area | medium shot, medium shot |
| Close Shot | Scene details | Material/atmosphere prop close-up | close shot, close shot |
| Extreme Close-up | Extremely local details | Material texture/key props | extreme closeup, extreme closeup |
...
|---|---|---|
| Early Morning | Misty soft light, warm-cool interwoven tones | Morning light faint, early morning mist |
| Noon | Bright, short shadows, vivid colors | Midday sun, bright light |
| Dusk | Golden tones, long shadows, sky gradient | Twilight golden glow, golden hour |
| Night (Moonlight) | Cool blue tones, quiet and cool | Moonlight clear glow, moonlight |
| Night (Lamplight) | Warm yellow accents, light-dark contrast | Lamplight dim, candlelight dots |
...
| Daytime → Night | Building/layout/materials | Overall darkens, add lamplight/moonlight atmosphere |
| Indoor Day → Indoor Night | Spatial structure, furniture | Overall tone warms, add candle flame/lantern elements |
...
|---|---|---|
| Sunny | Bright, clear shadows | Clear sky stretching far, bright sunshine |
| Cloudy | Even light, no hard shadows | Cloudy soft light, overcast |
| Mist | Reduced visibility, hazy air | Mist pervasive, foggy air |
| Light Rain | Water droplets, wet reflections, rain streaks | Drizzle like silk, rain curtain like gauze |
| Snowfall | White covering, snowflakes falling | Snowflakes flying thick, clad in white silver |

### Weather Derivative Specifications

| Derived From Base Weather | Keep Unchanged | Change Items |
|---|---|---|
| Sunny → Mist | Building/layout | Add fog layer, distant blur, saturation decrease |
| Sunny → Light Rain | Building/layout | Add rain streaks, ground reflections, tone slightly cool |
| Sunny → Snowfall | Building/layout | Add snow cover, snowflakes, tone leaning to white |
| Vegetation must adapt to weather logic | — | Rain: flower petals wet, Snow: withered branches frosted |
...
Chinese-style anime derivative scene image, based on reference image,
...
| R8 | Must include Chinese-style anime keywords (Chinese style anime / cel shading / fine brushstrokes) |
| R9 | Must include lens optical features (cel shading flat coloring / delicate lines / Japanese rendering) |
| R10 | Materials must have natural wear/years of marks, prohibit flawless "CG feel" |
...
| X6 | 3D realistic/CG animation/cartoon/game engine texture (disable 3D render, CGI, Unreal Engine, Unity, etc.) |
| X7 | Materials too clean and perfect, no signs of use or aged feel (avoid "plastic feel") |
| X8 | Lighting too even and flat, no depth of field blur, no lens optical features |
