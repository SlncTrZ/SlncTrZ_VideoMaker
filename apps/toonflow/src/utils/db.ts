...
async function initKnexType(knexDb: any) {
  ...
  const customHeader = `// This file is auto-generated by script, do not edit manually`;
  // Clear previous header comment
...
`;
  // Hash is based only on structural info, excluding header and whitespace
  ...
  try {
    ...
    // Same hash found in file header, skip write
