...
export default router.post(
  ...
  async (req, res) => {
    ...
    // Build base query: filter by projectId via o_eventChapter -> o_novel, then join o_event for name and content
    const baseQuery = u
      .db("o_event as e")
    ...
    // Paginated query: each event maps to multiple chapterIndex, aggregate with GROUP_CONCAT
