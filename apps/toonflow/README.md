...
# ToonFlowX — Google Flow Integration Fork

> **This repository is a fork of [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app).**  
> All credit for the original Toonflow project goes to [HBAI-Ltd](https://github.com/HBAI-Ltd) and [北京爱阿科技有限公司](https://toonflow.net).  
> This fork adds Google Flow integration for free image & video generation (Nano Banana / Veo 3.1) via Chrome extension.

[![Forked from HBAI-Ltd/Toonflow-app](https://img.shields.io/badge/Forked%20from-HBAI--Ltd%2FToonflow--app-181717?style=for-the-badge&logo=github)](https://github.com/HBAI-Ltd/Toonflow-app)
...
| Feature | Description |
|---------|-------------|
| **Google Flow Vendor** | Custom vendor for image (Nano Banana) & video (Veo 3.1) generation via [SlncTrZ_Everything-GenAI](https://github.com/SlncTrZ/SlncTrZ_Everything-GenAI) Chrome extension |
| **WS-Bridge Queue** | WebSocket bridge with command queue — serializes concurrent batch requests, sends one at a time to extension |
| **English Language** | All AI agent system prompts (skills) & video model prompts translated to English for more reliable output |
| **i18n Fixes** | Missing English/Vietnamese translations filled from original Chinese source |
| **AI Agent Language** | Agents now respond in the same language as the user (English/Vietnamese) instead of always Chinese |
...
| 仓库 / Repo | 说明 / Description | 链接 / Link |
|------------|-------------------|-------------|
| **ToonFlowX** (this fork) | Fork with Google Flow integration | [GitHub](https://github.com/SlncTrZ/ToonFlowX) |
| **Toonflow-app** (original) | 完整客户端（本仓库，推荐普通用户） | [GitHub](https://github.com/HBAI-Ltd/Toonflow-app) · [Gitee](https://gitee.com/HBAI-Ltd/Toonflow-app) |
| **Toonflow-web** | 前端源代码（适合前端开发者） | [GitHub](https://github.com/HBAI-Ltd/Toonflow-web) · [Gitee](https://gitee.com/HBAI-Ltd/Toonflow-web) |
| **SlncTrZ_Everything-GenAI** | Chrome extension for Google Flow integration | [GitHub](https://github.com/SlncTrZ/SlncTrZ_Everything-GenAI) |

> 💡 **提示**：如果您只是想使用 Toonflow，直接下载原版客户端即可。本仓库仅供需要 Google Flow 集成功能的开发者使用。
