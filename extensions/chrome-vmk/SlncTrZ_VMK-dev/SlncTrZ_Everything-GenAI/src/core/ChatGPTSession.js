...
class ChatGPTSession {
   ...
   *  3. Inject script (nếu chưa có flag __slnctrzChatGPTLoaded__).
  ...
  /**
   * Đảm bảo tab ChatGPT active (giống ensureFlowTabActive).
  ...
  static async ensureTabActive() {
    ...
    try {
      await this._sendToBackground('chatgpt:ensureActive', { tabId: this._tabId });
    } catch (err) {
