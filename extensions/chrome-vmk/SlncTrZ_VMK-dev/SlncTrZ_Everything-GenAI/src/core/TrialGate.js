...
class TrialGate {
  ...
  static _logDeprecation(method) {
    console.warn(`[SlncTrZ] TrialGate.${method}() is DEPRECATED. Use featureGate.${method}() instead.`);
  }
  ...
  static async init() {
    ...
    console.log('[SlncTrZ] TrialGate: Redirecting to FeatureGate');
  }
  ...
  static async resetUsage() {
    console.log('[SlncTrZ] TrialGate.resetUsage() is deprecated');
  }
}
