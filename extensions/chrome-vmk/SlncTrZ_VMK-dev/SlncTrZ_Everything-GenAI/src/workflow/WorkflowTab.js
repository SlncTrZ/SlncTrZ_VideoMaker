/**
 * WorkflowTab - Controller chính cho Tab 4: SlncTrZ VM
 */
class WorkflowTab {
  ...
  _renderSubtabs() {
    ...
    if (this.container.querySelector('.slnctrz-workflow-subtabs')) {
      return;
    }
    ...
    const subtabsHtml = `
      <div class="slnctrz-workflow-subtabs">
        <button class="slnctrz-workflow-subtab active" data-subtab="templates">
        ...
        <button class="slnctrz-workflow-subtab" data-subtab="workflows">
        ...
        <button class="slnctrz-workflow-subtab" data-subtab="shared">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span class="slnctrz-workflow-subtab-badge" data-shared-count style="display: none;">0</span>
        </button>
      </div>
      <div class="slnctrz-workflow-content" data-content="templates" style="display: flex; flex-direction: column; flex: 1; overflow: hidden;">
        <!-- WorkflowTemplateList content - lazy loaded -->
      </div>
      <div class="slnctrz-workflow-content" data-content="workflows" style="display: none; flex-direction: column; flex: 1; overflow: hidden;">
        <!-- WorkflowList content will be moved here -->
      </div>
      <div class="slnctrz-workflow-content" data-content="shared" style="display: none; flex-direction: column; flex: 1; overflow: hidden;">
   ...
   */
  _bindSubtabEvents() {
    const subtabBtns = this.container.querySelectorAll('.slnctrz-workflow-subtab');
  ...
  _switchSubtab(subtab) {
    ...
    const contentPanes = this.container.querySelectorAll('.slnctrz-workflow-content');
