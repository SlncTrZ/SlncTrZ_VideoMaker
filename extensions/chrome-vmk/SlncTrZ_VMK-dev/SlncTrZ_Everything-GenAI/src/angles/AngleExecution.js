  ...
  async _getGenDefaults() {
    ...
    try {
      ...
      this._genDefaults = {
        ...
        // Group C: ModelRegistry-aware fallback
        imageModel: result.defaultImageModel || window.ModelRegistry?.getDefault('flow', 'image') || 'Nano Banana 2',
        videoModel: result.defaultVideoModel || window.ModelRegistry?.getDefault('flow', 'video') || 'Veo 3.1 - Fast'
      };
    } catch (e) {
      this._genDefaults = {
        genType: 'Image', ratio: '9:16',
        imageModel: window.ModelRegistry?.getDefault('flow', 'image') || 'Nano Banana 2',
        videoModel: window.ModelRegistry?.getDefault('flow', 'video') || 'Veo 3.1 - Fast'
      };
    }
