 ...
 * - KHÔNG hỗ trợ quantity (Grok UI SlncTrZ VM mode không có quantity selector).
...
class GrokAdapter extends AIProviderAdapter {
  ...
  async submit(params = {}) {
    ...
    // Grok KHÔNG có quantity selector trong SlncTrZ VM mode → bỏ qua quantity entirely.
