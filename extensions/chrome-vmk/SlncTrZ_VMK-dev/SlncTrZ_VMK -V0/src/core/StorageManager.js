...
class StorageManager {
  ...
  // Khởi tạo
  async init() {
    // PATCHED: Force local mode (offline — no backend)
    this.mode = 'local';
  ...
  async switchToApi() {
    ...
    // PATCHED: Offline mode — no-op, keep local
    console.warn('[StorageManager] switchToApi called but offline mode forced');
