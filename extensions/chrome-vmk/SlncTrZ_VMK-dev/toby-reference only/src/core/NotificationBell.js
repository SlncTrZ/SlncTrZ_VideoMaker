...
class NotificationBell {
  ...
  constructor() {
    ...
    this.pollIntervalMs = 60000; // Poll mỗi 60 giây (backup cho SSE)
  ...
  async fetchUnreadCount() {
    ...
    try {
      ...
      console.log('[NotificationBell] fetchUnreadCount response:', resp);
      ...
      if (resp?.success && resp?.data !== undefined) {
        ...
        console.log('[NotificationBell] Parsed unread count:', count);
