...
class AIProviderAdapter {
  constructor() {
    ...
    // Phase J: Hardcoded fallbacks — subclass should override via getter
  ...
  /**
   * Phase J: Capabilities getter — base class returns defaults.
   * Subclass override to merge PCM server data.
   */
  get capabilities() {
