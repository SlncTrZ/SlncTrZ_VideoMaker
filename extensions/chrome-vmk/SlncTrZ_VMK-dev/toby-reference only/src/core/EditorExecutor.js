...
class EditorExecutor {
  ...
  async _maybeApplySettings(item) {
    ...
    console.log(`[EditorExecutor] Calling applySettings: genType=${needed.genType}, ratio=${needed.ratio}, model=${needed.model}, isFrames=${needed.isFrames}, quantity=${needed.quantity}`);
